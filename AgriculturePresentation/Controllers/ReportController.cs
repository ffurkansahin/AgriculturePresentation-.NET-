...
namespace AgriculturePresentation.Controllers
{
    public class ReportController : Controller
    {
        ...
        public List<ContactModel> contactList()
        {
            ...
            {
                contactModels=context.Contacts.Select(i=>new ContactModel 
                {
                    ContactID=i.ContactID,
                    ContactName=i.Name,
                    ContactMail=i.Mail,
                    ContactMessage=i.Message,
                    ContactDate=i.Date
                }).ToList();
            }
        ...
        public List<AnnouncementModel> AnnouncementList()
        {
            ...
            using (var context = new AgricultureContext())
            {
                announcementModels = context.Announcements.Select(i => new AnnouncementModel
                {
                    ID=i.AnnouncementID,
                    Title=i.Title,
        ...
        public IActionResult AnnouncementReport()
        {
            using (var workBook = new XLWorkbook())
            {
                ...
                workSheet.Cell(1, 5).Value = "Durum Tarihi";
